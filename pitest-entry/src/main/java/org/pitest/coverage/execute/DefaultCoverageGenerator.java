...
public class DefaultCoverageGenerator implements CoverageGenerator {
  ...
  private static void verifyBuildSuitableForMutationTesting(final CoverageData coverage) {
      System.out.println("im second");
            System.out.println(ReportOptions.debug);System.out.println(ReportOptions.debug);System.out.println(ReportOptions.debug);System.out.println(ReportOptions.debug);System.out.println(ReportOptions.debug);System.out.println(ReportOptions.debug);System.out.println(ReportOptions.debug);      
    if (!ReportOptions.debug && !coverage.allTestsGreen()) {
